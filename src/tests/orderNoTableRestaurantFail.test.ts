...
describe('POST /api/orders/d0f5bcf9-30f8-4ec2-b4d5-9457cf08d80e', () => {
    it('should return 400 Bad Request with a message "br_stol is not a valid table in this restaurant"', async () => {
        const orderData = {
            br_stol: 50,
            items: [
                {
        ...
        expect(response.body).toStrictEqual({
            message: 'br_stol is not a valid table in this restaurant',
        })
    })
})
